...
const EditDriver = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedDriver = { name, gender, email, phoneNumber, cnic, dateOfBirth, ratings };
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(result.message || 'Error updating driver. Please try again.');
      }
    } catch (error) {
      console.error('Error updating driver:', error);
      setError('Error updating driver. Please try again.');
    }
  };
